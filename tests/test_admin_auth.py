...
def _make_user_resp(user_id: str = "user-123", is_admin: bool = True):
    ...
    user = SimpleNamespace(id=user_id, app_metadata=metadata)
    return SimpleNamespace(user=user)


@patch("server.admin_auth.get_supabase")
class TestRequireAdmin:
    """Tests for require_admin()."""

    def test_valid_admin_token(self, mock_get_sb):
        sb = MagicMock()
    ...
    def test_non_admin_user_raises_403(self, mock_get_sb):
        sb = MagicMock()
    ...
    def test_missing_authorization_header_raises_401(self, mock_get_sb):
    ...
    def test_malformed_header_raises_401(self, mock_get_sb):
        mock_get_sb.return_value = MagicMock()
    ...
    def test_supabase_not_configured_raises_503(self, mock_get_sb):
    ...
    def test_invalid_token_get_user_raises_401(self, mock_get_sb):
        sb = MagicMock()
